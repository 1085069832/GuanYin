...
function OnGUI(){
  GUI.Label(Rect(Screen.width/2,Screen.height/2-50,Screen.width,Screen.height),currObjAlive.name);
  GUI.Label(Rect(50,50,Screen.width,Screen.height),"Use the Up and Down arrow keys to change spells!");
